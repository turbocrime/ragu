...
#[library_benchmark]
#[bench::default(args = (mock_rng(),), setup = setup_element_mul)]
...
#[library_benchmark]
#[bench::default(args = (mock_rng(),), setup = setup_element_invert)]
...
#[library_benchmark]
#[bench::default(args = (mock_rng(),), setup = setup_element_fold_8)]
...
#[library_benchmark]
#[bench::default(args = (mock_rng(),), setup = setup_element_is_zero)]
...
#[library_benchmark]
#[bench::default(args = (mock_rng(),), setup = setup_element_multiadd_8)]
...
#[library_benchmark]
#[bench::default(args = (mock_rng(),), setup = setup_point_single)]
...
#[library_benchmark]
#[bench::default(args = (mock_rng(),), setup = setup_point_pair)]
...
#[library_benchmark]
#[bench::default(args = (mock_rng(),), setup = setup_bool_256)]
...
#[library_benchmark]
#[bench::default(args = (mock_rng(),), setup = setup_sponge)]
fn sponge_absorb_squeeze((input, poseidon): (Fp, &'static <ragu_pasta::Pasta as Cycle>::CircuitPoseidon)) {
    black_box(BenchEmulator::emulate_wireless(input, |dr, witness| {
...
#[library_benchmark]
#[bench::default(args = (mock_rng(),), setup = setup_group_scale)]
...
#[library_benchmark]
#[bench::default(args = (mock_rng(),), setup = setup_extract)]
...
#[library_benchmark]
#[bench::default(args = (mock_rng(),), setup = setup_field_scale)]
...
main!(
    library_benchmark_groups = element_ops, point_ops, boolean_ops, sponge_ops, endoscalar_ops
);
