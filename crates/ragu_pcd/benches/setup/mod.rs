...
use ragu_pcd::{Application, ApplicationBuilder, NoHooks, Pcd};
...
pub fn setup_finalize() -> (
    ApplicationBuilder<'static, Pasta, ProductionRank, 4, NoHooks>,
...
pub fn setup_seed() -> (
    Application<'static, Pasta, ProductionRank, 4, NoHooks>,
